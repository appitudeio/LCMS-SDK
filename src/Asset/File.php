<?php
	...
	*/
	...
	class File extends SplFileInfo
	{
	     ...
	     * @param string|null $originalName The original file name (optional, defaults to basename of $path)
	     ...
	     * @api
	     */
	    public function __construct(string $path, ?string $originalName = null, ?int $error = null)
	    {
	        $this->originalName = $this->getName($originalName ?? basename($path));
	        $this->error = $error ?? UPLOAD_ERR_OK;
	        $this->test = !is_uploaded_file($path);
